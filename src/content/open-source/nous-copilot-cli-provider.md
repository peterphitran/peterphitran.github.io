...
date: "2026-06-27"
excerpt: "A 'good first issue' in a large TypeScript monorepo turned into a lesson in moving targets: the CLI command I built on got deprecated mid-review, so I retargeted to a supported surface and hardened the process handling across three review rounds before it merged."
---
